...
class Usdc extends StatefulWidget {
  const Usdc({Key? key}) : super(key: key);

  @override
  State<Usdc> createState() => _UsdcState();
}

class _UsdcState extends State<Usdc> {
  ...
  String _selectedCurrency = 'USDC'; // Track the selected currency
